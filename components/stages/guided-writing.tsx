...
export default function GuidedWriting({ language, storyState, onStoryWrite, onBack, userId }: GuidedWritingProps) {
  ...
  return (
    <div className="min-h-screen py-8 px-6 bg-gradient-to-br from-green-100 via-emerald-50 via-blue-50 via-purple-50 to-pink-50 relative overflow-hidden" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
      {/* 高级背景装饰元素 */}
