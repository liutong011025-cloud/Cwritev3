...
export default function WelcomePage({ language, onLanguageChange, onStart, onBack, userId }: WelcomePageProps) {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-50 via-pink-50 to-orange-50 relative" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
      {/* Progress Mentor */}
      <ProgressMentor
        stage="welcome"
