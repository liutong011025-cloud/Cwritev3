...
Created with Story Writer
  ...
  return (
    <div className="min-h-screen py-8 px-6 bg-gradient-to-br from-indigo-100 via-purple-50 via-pink-50 to-orange-50 relative" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
      {/* 背景图片 - 使用结构生成的图片 */}
